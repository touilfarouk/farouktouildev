  ...
  [888],
  {
    ...
    3463: function (e, t, n) {
      ...
      e.exports = function e(t, n, r) {
        if ("string" != typeof n) {
          ...
          var s = u(n);
          d && (s = s.concat(d(n)));
          for (var i = l(t), m = l(n), y = 0; y < s.length; ++y) {
            var h = s[y];
            if (!o[h] && !(r && r[h]) && !(m && m[h]) && !(i && i[h])) {
              var b = p(n, h);
              try {
                c(t, h, b);
              } catch (e) {}
    ...
    3366: function (e, t, n) {
      ...
      let u = (e) => "init" in e,
        ...
        h = (e, t) => "v" in e && "v" in t && Object.is(e.v, t.v),
        ...
        w = () => {
          ...
          let o = (e) => n.get(e),
            ...
            l = (e, t, n) => {
              let r = o(e),
                a = { d: (null == r ? void 0 : r.d) || new Map(), v: t };
              return (n && i(e, a, n), r && h(r, a) && r.d === a.d)
                ? r
                : (s(e, a), a);
            },
            c = (e, t, n, r) => {
                  ...
                  t.then(
                    (t) => {
                      if (!c) {
                        ...
                        m(s, t),
                          r(t),
                          (null == a ? void 0 : a.d) !== i.d &&
                            N(e, i, null == a ? void 0 : a.d);
                      }
                    },
                    (t) => {
                      if (!c) {
                        ...
                        y(s, t),
                          i(t),
                          (null == r ? void 0 : r.d) !== a.d &&
                            N(e, a, null == r ? void 0 : r.d);
                      }
                    }
                  ),
                    (a = (e) => {
            ...
            p = (e, t, n) => {
              let r = o(e),
                a = { d: (null == r ? void 0 : r.d) || new Map(), e: t };
              return (n && i(e, a, n), r && b(r, a) && r.d === a.d)
                ? r
                : (s(e, a), a);
            },
            w = (e) => {
              ...
              if (
                ...
                Array.from(a.d).every(([t, n]) => t === e || o(t) === n))
              )
                return a;
              let s = new Map(),
                i = !0,
            ...
            R = (e, n) => {
              let a = { t: new Set(n && [n]), l: new Set() };
              if (
                (r.set(e, a),
                t.add(e),
                w(e).d.forEach((t, n) => {
                  let a = r.get(n);
                  a ? a.t.add(e) : n !== e && R(n, e);
                }),
                w(e),
                d(e) && e.onMount)
              ) {
            ...
            N = (e, t, n) => {
              ...
              null == n ||
                n.forEach((t, n) => {
                  ...
                  let o = r.get(n);
                  o && (o.t.delete(e), S(n, o) && L(n));
                }),
                a.forEach((t) => {
                  let n = r.get(t);
                  n ? n.t.add(e) : r.has(e) && R(t, e);
                });
            },
            _ = () => {
              for (; a.size; ) {
            ...
            $ = (t, n) => {
              ...
              return (
                ...
                e.forEach((e) => e("sub")),
                () => {
                  a.delete(n), A(t), e.forEach((e) => e("unsub"));
                }
              );
            };
          return {
            ...
            dev_restore_atoms: (e) => {
              for (let [t, n] of e) u(t) && (c(t, n), j(t));
              _();
            },
          };
        },
      ...
      let V = () => {
          ...
          (e.rel = "stylesheet"),
            (e.href =
              "https://fonts.googleapis.com/css2?family=Titillium+Web:wght@300;400;600&display=swap"),
        ...
        let r = {
          getItem: (r, a) => {
            ...
            let i = (e) => {
              ...
              l =
                null != (s = null == (o = e()) ? void 0 : o.getItem(r))
                  ? s
                  : null;
      ...
      function et(e, t, n = ee) {
        ...
        (r.debugPrivate = !0),
          (r.onMount = (r) => {
            ...
            let o = n.getItem(e, t);
            return (
              o instanceof Promise ? o.then((e) => r(e)) : r(o),
              n.subscribe && (a = n.subscribe(e, r, t)),
              a
            );
          });
        let a = c(
      ...
      let eo = (e) => {
        let { children: t } = e,
          ...
          o = (0, i.useId)(),
          s = !!window.matchMedia,
          l = s && window.document.querySelector("#app-modal-container");
        return ((0, i.useEffect)(() => {
          r(!0);
        }, []),
        n && l)
          ? (0, ea.createPortal)(t, l, o)
          : (0, a.jsx)(a.Fragment, {});
      };
      n(5565);
      var es = "czken63",
        ...
        ec = i.forwardRef(function (e, t) {
          var n = el(el({}, i.useContext(M.s)), e);
          return i.createElement(
            "svg",
            el(
              {
        ...
        ed = i.forwardRef(function (e, t) {
          var n = eu(eu({}, i.useContext(M.s)), e);
          return i.createElement(
            "svg",
            eu(
              {
      ...
      let ep = (e) => {
          let {
            ...
            c = (0, R.s0)();
          return (0, a.jsx)(R.LH, {
            children: (0, a.jsxs)(R.fS, {
              className: "czken61",
              animated: [(0, R.rn)(), o],
              children: [
                !!i &&
                  (0, a.jsx)("button", {
                    className: (0, R.cx)(N.pC, es, "czken64", ei),
                    onClick: () => {
                      var e;
                ...
                (0, a.jsx)(F(), {
                  href: t,
                  className: (0, R.cx)(
                    n ? (0, R.cx)(N.Eo, "czken6a") : (0, R.cx)(N.pC, ei),
                    "czken62"
                  ),
                  onClick: s,
                  children: r,
                ...
                !!l &&
                  (0, a.jsx)("button", {
                    className: (0, R.cx)(N.pC, es, "czken65", ei),
                    onClick: () => {
                      var e;
        ...
        ef = i.createContext("fr"),
        eg = {
          fr: {
            title: "Naviguer",
            github: "GitHub",
            aboutMe: "\xe0-propos-de-moi",
        ...
        em = (e) => {
          let { onClose: t } = e,
            { asPath: n } = (0, _.useRouter)(),
            r = (0, R.s0)(),
            o = (0, i.useContext)(ef),
            [s, l] = (0, i.useState)(
              n.startsWith("/a-propos-de-moi") ? "/a-propos-de-moi" : "/"
            ),
            c = () => {
              var e;
            ...
            footer: (0, a.jsx)(a.Fragment, {
              children: (0, a.jsx)(R.LH, {
                children: (0, a.jsx)("div", {
                  ...
                  children: (0, a.jsxs)(R.fS, {
                    as: "a",
                    href: "https://github.com/touilfarouk",
                    target: "github",
                    className: (0, R.cx)(N.pC, ei, "czken67"),
                    animated: [(0, R.aa)("y", "1rem", 0, 0)],
                    children: [
                      (0, a.jsx)(P, {}),
                      (0, a.jsx)("span", {
                        className: N.bV,
                        children: eg[o].github,
                      }),
                    ],
                  }),
                }),
      ...
      let ev = (e) => {
          let t = (0, _.useRouter)(),
            ...
            [l, c] = (0, i.useState)(!1),
            u = "/" === t.asPath,
            d = u ? (0, R.rn)() : [(0, R.Wx)(), (0, R.aa)("x", -4, 0, 0)],
            p = u ? (0, R.rn)() : [(0, R.Wx)(), (0, R.aa)("x", 4, 0, 0)];
            ...
            children: [
              (0, a.jsx)(L.T$, {
                ...
                left: (0, a.jsxs)(R.LH, {
                  ...
                  children: [
                    (0, a.jsx)(R.LH, {
                      children: (0, a.jsx)(L.TR, {
                        animated: (0, R.Wx)(),
                        children:
                          !u &&
                          (0, a.jsx)(R.LH, {
                            merge: !0,
                            children: (0, a.jsx)(L.nJ, {
                              className: N.bV,
                              animated: d,
                            }),
                          }),
                    ...
                    !u &&
                      (0, a.jsx)(R.LH, {
                        ...
                        children: (0, a.jsx)(L.v2, {
                          children: (0, a.jsx)(R.LH, {
                            children: (0, a.jsx)(L.sN, {
                              className: (0, R.cx)(eb, N.bV),
              ...
              (0, a.jsx)(R.QS, {
                duration: { enter: 0.1, exit: 0.1, stagger: 0.05 },
                disabled: !1,
                dismissed: !1,
                children: (0, a.jsx)(R.LH, {
                  root: !0,
                  active: l,
                  children: (0, a.jsx)(ey, { onClose: () => c(!1) }),
                }),
              }),
            ],
          });
        },
        ex = { duration: { enter: 0.15, exit: 0.15, stagger: 0.05 } },
        ew = {
          master: { volume: 0.8 },
          categories: {
              ...
              children: [
                (0, a.jsxs)(s(), {
                  children: [
                    ...
                    (0, a.jsx)("title", { children: "Codacom" }),
                    (0, a.jsx)("meta", {
                      name: "description",
                ...
                (0, a.jsxs)(R.LH, {
                  ...
                  children: [
                    (0, a.jsxs)(L.Zn, {
                      children: [(0, a.jsx)(ev, {}), (0, a.jsx)(t, { ...n })],
                    }),
                    (0, a.jsx)("div", { id: "app-modal-container" }),
                  ],
                }),
              ],
            }),
    ...
    8995: function (e, t, n) {
      ...
      n(7533);
      let T = (e) => {
        let { className: t, animated: n } = e,
          r = (0, F.useRouter)(),
          a = "/" === r.asPath;
        return (0, _.jsx)($.LH, {
          merge: !0,
          combine: !0,
          children: (0, _.jsxs)($.fS, {
            role: "presentation",
            className: (0, $.cx)("_1hhzp0i0", t),
            animated: n,
            children: [
              (0, _.jsx)($.LH, {
                children: (0, _.jsxs)($.fS, {
      ...
      let M = (e) => {
        ...
        return (0, _.jsxs)("div", {
          lang: "en",
          className: (0, $.cx)("bltsnn0", t),
          children: [
            (0, _.jsx)(T, {}),
            (0, _.jsx)("div", { className: "bltsnn1", children: n }),
          ],
        });
      };
      n(9438);
      ...
      let P = (e) => {
        ...
        return (0, _.jsxs)($.fS, {
          ...
          onClick: () => {
            var e;
            null == l || l(),
              null === (e = d.click) || void 0 === e || e.play();
          },
          children: [
            "simple" === s &&
              (0, _.jsx)("div", { className: (0, $.cx)(I, "th8yui5") }),
            "hexagon" === s &&
              (0, _.jsxs)("div", {
                className: (0, $.cx)(I, "th8yui7"),
                children: [
                  (0, _.jsx)($.rT, {
                    className: "th8yui8",
            ...
            (0, _.jsx)("div", { className: "th8yui2", children: c }),
          ],
        });
      };
      n(8064);
      let D = (e) => {
        let { className: t, animated: n, children: r } = e;
        return (0, _.jsx)($.fS, {
          as: "ul",
          className: (0, $.cx)("_1l69nam0", t),
          animated: n,
          children: r,
        });
      };
      n(4021);
      let B = (e) => {
        let { className: t, animated: n, active: r, children: a } = e,
          o = (0, $.s0)();
        return (0, _.jsx)($.fS, {
          as: "li",
          className: (0, $.cx)("_1izpm6h0", r && "_1izpm6h1", t),
          animated: n,
          onClick: () => {
            var e;
      ...
      let U = (e) => {
        ...
        return (0, _.jsx)($.fS, {
          ...
          children: (0, _.jsxs)(W(), {
            className: "razuih2",
            href: "/",
            title: "Codacom Project",
            children: [
              (0, _.jsx)("img", {
                className: "razuih4",
                src: "/farouktouil_logo.png",
                alt: "Codacom Project",
              }),
              r,
            ],
        ...
        return (0, _.jsx)($.fS, {
          ...
          children: (0, _.jsxs)("div", {
            ...
            children: [
              ...
              (0, _.jsx)($.fS, {
                className: (0, $.cx)(q, "l9j4si4"),
                animated: (0, $.aa)("x", -12, 0),
                children: a,
              }),
              (0, _.jsx)($.fS, {
                className: (0, $.cx)(q, "l9j4si5"),
                animated: (0, $.aa)("scaleX", 0.9, 1),
                children: o,
              }),
              (0, _.jsx)($.fS, {
                className: (0, $.cx)(q, "l9j4si6"),
                animated: (0, $.aa)("x", 12, 0),
                children: s,
              }),
            ],
      ...
      let Y = (e) => {
        ...
        return (0, _.jsxs)($.fS, {
          as: "main",
          className: (0, $.cx)("mynlp60", s && "mynlp61", t),
          style: n,
          animated: r,
          children: [
            o &&
              (0, _.jsx)($.LH, {
                children: (0, _.jsxs)($.fS, {
                  ...
                  animated: (0, $.Wx)(),
                  children: [
                    (0, _.jsx)($.oG, { className: "page-document__svg" }),
                    (0, _.jsx)($.rT, {
      ...
      let V = (e) => {
        ...
        return (0, _.jsxs)($.fS, {
          as: "article",
          className: (0, $.cx)("_2uva910", t),
          animated: n,
          children: [
            (0, _.jsx)($.oG, { squareSize: 16, leftBottom: !1, rightTop: !1 }),
            (0, _.jsxs)("div", {
              className: "_2uva911",
              children: [
                (0, _.jsx)("div", {
                ...
                (0, _.jsxs)("div", {
                  className: "_2uva914",
                  children: [
                    (0, _.jsx)("h1", { className: "_2uva915", children: o }),
                    (0, _.jsx)("div", { className: "_2uva916", children: s }),
                  ],
                }),
              ],
            }),
      ...
      var er =
        ((s =
                          ...
                          for (var d in s)
                            if (s.hasOwnProperty(d) && s[d]) {
                              ...
                              for (var f = 0; f < p.length; ++f) {
                                ...
                                for (
                                  var x = g.pattern || g, w = l.next, k = c;
                                  w !== n.tail && (!u || !(k >= u.reach));
                                  ...
                                  if (!(S instanceof a)) {
                                    ...
                                    if (h) {
                                      ...
                                      for (
                                        var R = w;
                                        R !== n.tail &&
                                        (C < O || "string" == typeof R.value);
                                        R = R.next
                                      )
                                        A++, (C += R.value.length);
                                      A--, (S = t.slice(k, C)), (E.index -= k);
                                    } else if (!(E = o(x, 0, S, y))) continue;
                                    var j = E.index,
                                      L = E[0],
                                      N = S.slice(0, j),
                                      _ = S.slice(j + L.length),
                                      $ = k + S.length;
                                    u && $ > u.reach && (u.reach = $);
                                    var F = w.prev;
                                    N && ((F = i(n, F, N)), (k += N.length)),
                                      (function (e, t, n) {
                                        for (
                                          var r = t.next, a = 0;
                                          a < n && r !== e.tail;
                                    ...
                                    if (
                                      ((w = i(n, F, T)), _ && i(n, w, _), A > 1)
                                    ) {
                                      var M = { cause: d + "," + f, reach: $ };
                                      e(t, n, s, w.prev, k, M),
                                        u &&
                                          M.reach > u.reach &&
                                          (u.reach = M.reach);
          ...
          function () {
            return (
              a || (0, r[ee(r)[0]])((a = { exports: {} }).exports, a), a.exports
            );
          })())
            ? K(et(o))
            : {}),
          ...
          if ((t && "object" == typeof t) || "function" == typeof t)
            for (let n of ee(t))
              en.call(e, n) ||
                ...
                Q(e, n, {
                  get: () => t[n],
                  enumerable: !(r = J(t, n)) || r.enumerable,
                });
          return e;
        })(
          o && o.__esModule ? s : Q(s, "default", { value: o, enumerable: !0 }),
          o
        ));
      (i = er),
        (l = { pattern: /\\[\\(){}[\]^$+*?|.]/, alias: "escape" }),
        (u = RegExp(
          (u =
            "(?:[^\\\\-]|" +
            (c =
        ...
        (er.languages.javascript = er.languages.extend("clike", {
          "class-name": [
            er.languages.clike["class-name"],
            {
              pattern:
        ...
        (er.languages.javascript["class-name"][0].pattern =
          /(\b(?:class|extends|implements|instanceof|interface|new)\s+)[\w.\\]+/),
        er.languages.insertBefore("javascript", "keyword", {
          regex: {
            pattern: RegExp(
          ...
          parameter: [
            {
              ...
              lookbehind: !0,
              inside: er.languages.javascript,
            },
            {
              pattern:
        ...
        er.languages.insertBefore("javascript", "string", {
        ...
        er.languages.insertBefore("javascript", "operator", {
          "literal-property": {
            pattern:
        ...
        er.languages.markup &&
          (er.languages.markup.tag.addInlined("script", "javascript"),
          er.languages.markup.tag.addAttribute(
            /on(?:abort|blur|change|click|composition(?:end|start|update)|dblclick|error|focus(?:in|out)?|key(?:down|up)|load|mouse(?:down|enter|leave|move|out|over|up)|reset|resize|scroll|select|slotchange|submit|unload|wheel)/
              .source,
            "javascript"
          )),
        (er.languages.js = er.languages.javascript),
        (er.languages.actionscript = er.languages.extend("javascript", {
          keyword:
            /\b(?:as|break|case|catch|class|const|default|delete|do|dynamic|each|else|extends|final|finally|for|function|get|if|implements|import|in|include|instanceof|interface|internal|is|namespace|native|new|null|override|package|private|protected|public|return|set|static|super|switch|this|throw|try|typeof|use|var|void|while|with)\b/,
          operator: /\+\+|--|(?:[+\-*\/%^]|&&?|\|\|?|<<?|>>?>?|[!=]=?)=?|[~?@]/,
        })),
        (er.languages.actionscript["class-name"].alias = "function"),
        delete er.languages.actionscript.parameter,
        delete er.languages.actionscript["literal-property"],
        er.languages.markup &&
          er.languages.insertBefore("actionscript", "string", {
            xml: {
              pattern:
                /(^|[^.])<\/?\w+(?:\s+[^\s>\/=]+=("|')(?:\\[\s\S]|(?!\2)[^\\])*\2)*\s*\/?>/,
              lookbehind: !0,
              inside: er.languages.markup,
            },
          }),
        (f = /#(?!\{).+/),
        (g = { pattern: /#\{[^}]+\}/, alias: "variable" }),
        ((p = er).languages.coffeescript = p.languages.extend("javascript", {
          comment: f,
          string: [
        ...
        p.languages.insertBefore("coffeescript", "comment", {
          ...
          "block-regex": {
            pattern: /\/{3}[\s\S]*?\/{3}/,
            alias: "regex",
            inside: { comment: f, interpolation: g },
          },
        }),
        ...
        delete p.languages.coffeescript["template-string"],
        (p.languages.coffee = p.languages.coffeescript),
        Object.defineProperty(
          (m = er.languages.javadoclike =
            {
              parameter: {
                pattern:
              ...
              (e = "string" == typeof e ? [e] : e).forEach(function (e) {
                ...
                if ((a = er.languages[e])) {
                  ...
                  if (
                    ((o =
                      o ||
                      (a = er.languages.insertBefore(e, "comment", {
                        "doc-comment": {
                          pattern: /(^|[^\\])\/\*\*[^/][\s\S]*?(?:\*\/|$)/,
                          lookbehind: !0,
                          alias: "comment",
        ...
        (er.languages.markup.tag.inside["attr-value"].inside.entity =
          er.languages.markup.entity),
        (er.languages.markup.doctype.inside["internal-subset"].inside =
          er.languages.markup),
        er.hooks.add("wrap", function (e) {
          "entity" === e.type &&
            (e.attributes.title = e.content.replace(/&amp;/, "&"));
        }),
        Object.defineProperty(er.languages.markup.tag, "addInlined", {
          value: function (e, t) {
            var n = {},
              n =
                ((n["language-" + t] = {
            ...
            (t[e] = {
              ...
              er.languages.insertBefore("markup", "cdata", t);
          },
        }),
        Object.defineProperty(er.languages.markup.tag, "addAttribute", {
          value: function (e, t) {
            er.languages.markup.tag.inside["special-attr"].push({
              pattern: RegExp(
                /(^|["'\s])/.source +
                  "(?:" +
                  e +
        ...
        (er.languages.html = er.languages.markup),
        (er.languages.mathml = er.languages.markup),
        (er.languages.svg = er.languages.markup),
        (er.languages.xml = er.languages.extend("markup", {})),
        (er.languages.ssml = er.languages.xml),
        (er.languages.atom = er.languages.xml),
        (er.languages.rss = er.languages.xml),
        (function (e) {
          var t = /(?:\\.|[^\\\n\r]|(?:\n|\r\n?)(?![\r\n]))/.source;
          function n(e) {
            return (
        ...
        er.hooks.add("after-tokenize", function (e) {
              ...
              if ("keyword" === r.type && "mutation" === r.content) {
                ...
                if (
                  ...
                  for (; n < o; n++) {
                    var s = t[n + 0];
                    "variable" === s.type &&
                      (p(s, "variable-input"), a.push(s.content));
                  }
                  n = o + 1;
                }
                if (
                  ...
                  "{" === t[n + 0].content &&
                  (p(t[++n + 0], "property-mutation"), 0 < a.length)
                ) {
                  var i = d(/^\{$/, /^\}$/);
                  if (-1 !== i)
                    for (var l = n; l < i; l++) {
              ...
              (function t(n) {
                for (var s = 0, l = n.length; s < l; s++) {
                  var c,
                    ...
                    p = n[s];
                  "string" != typeof p &&
                    (Array.isArray((c = p.content))
                      ? "template-string" === p.type
                        ? ((p = c[1]),
                          3 === c.length &&
                            "string" != typeof p &&
                            ...
                            (p = Array.isArray((p = p.alias)) ? p[0] : p),
                            (d = e.languages[p])) &&
                            (c[1] = (function (t, n, s) {
                              var l = e.tokenize(t, {
                                  interpolation: {
                                    ...
                                    "string" == typeof h.content
                                      ? ((s = d[c]),
                                        -1 !==
                                          ...
                                          (f = m.substring(y + s.length)),
                                          (g = []),
                                          l && g.push(l),
                                          g.push(p),
                                          f &&
                                            (t((m = [f])), g.push.apply(g, m)),
                                          "string" == typeof h
                                            ? (n.splice.apply(
                                                n,
                                                [o, 1].concat(g)
                                              ...
                                              (o += g.length - 1))
                                            : (h.content = g)))
                                      : Array.isArray((y = h.content))
                                      ? t(y)
                                      : t([y]);
                                  }
                                })(l),
                                new e.Token(s, l, "language-" + s, t)
                              );
                            })(u, d, p)))
                        : t(c)
                      : "string" != typeof c && t([c]));
        ...
        ((b = er).languages.typescript = b.languages.extend("javascript", {
          "class-name": {
            pattern:
        ...
        (v = b.languages.extend("typescript", {})),
        delete v["class-name"],
        (b.languages.typescript["class-name"].inside = v),
        b.languages.insertBefore("typescript", "function", {
          ...
          "generic-function": {
            ...
            inside: {
              ...
              generic: { pattern: /<[\s\S]+/, alias: "class-name", inside: v },
            },
          },
        }),
        (b.languages.ts = b.languages.typescript),
        (w = (x = er).languages.javascript),
        (E =
          "(@(?:arg|argument|param|property)\\s+(?:" +
          (k = /\{(?:[^{}]|\{(?:[^{}]|\{[^{}]*\})*\})+\}/.source) +
          "\\s+)?)"),
        (x.languages.jsdoc = x.languages.extend("javadoclike", {
          parameter: {
        ...
        x.languages.javadoclike.addSupport("javascript", x.languages.jsdoc),
        ((S = er).languages.flow = S.languages.extend("javascript", {})),
        S.languages.insertBefore("flow", "keyword", {
          type: [
            {
              pattern:
        ...
        (S.languages.flow["function-variable"].pattern =
          /(?!\s)[_$a-z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*=\s*(?:function\b|(?:\([^()]*\)(?:\s*:\s*\w+)?|(?!\s)[_$a-z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*)\s*=>))/i),
        delete S.languages.flow.parameter,
        S.languages.insertBefore("flow", "operator", {
          "flow-punctuation": { pattern: /\{\||\|\}/, alias: "punctuation" },
        }),
        Array.isArray(S.languages.flow.keyword) ||
          (S.languages.flow.keyword = [S.languages.flow.keyword]),
        S.languages.flow.keyword.unshift(
          {
        ...
        (er.languages.n4js = er.languages.extend("javascript", {
          keyword:
        ...
        er.languages.insertBefore("n4js", "constant", {
          annotation: { pattern: /@+\w+/, alias: "operator" },
        }),
        (er.languages.n4jsd = er.languages.n4js),
        (function (e) {
          function t(e, t) {
            return RegExp(
                  ...
                  "string" != typeof o &&
                    ...
                    (i || "string" == typeof o) &&
                      ...
                      a < n.length - 1 &&
                        ...
                        ((i += s(n[a + 1])), n.splice(a + 1, 1)),
                      0 < a &&
                        ("string" == typeof n[a - 1] ||
                          "plain-text" === n[a - 1].type) &&
                        ((i = s(n[a - 1]) + i), n.splice(a - 1, 1), a--),
        ...
        (j = (A = er).util.clone(A.languages.typescript)),
        (((A.languages.tsx = A.languages.extend("jsx", j)),
        delete A.languages.tsx.parameter,
        delete A.languages.tsx["literal-property"],
        (j = A.languages.tsx.tag)).pattern = RegExp(
          /(^|[^\w$]|(?=<\/))/.source + "(?:" + j.pattern.source + ")",
          j.pattern.flags
        )),
        (j.lookbehind = !0),
        (er.languages.swift = {
        ...
        er.languages.swift["string-literal"].forEach(function (e) {
          e.inside.interpolation.inside = er.languages.swift;
        }),
        ((O = er).languages.kotlin = O.languages.extend("clike", {
          keyword: {
            pattern:
        ...
        delete O.languages.kotlin["class-name"],
        (C = {
          "interpolation-punctuation": {
            pattern: /^\$\{?|\}$/,
            alias: "punctuation",
          },
          expression: { pattern: /[\s\S]+/, inside: O.languages.kotlin },
        }),
        ...
        delete O.languages.kotlin.string,
        O.languages.insertBefore("kotlin", "keyword", {
          annotation: {
            pattern: /\B@(?:\w+:)?(?:[A-Z]\w*|\[[^\]]+\])/,
            alias: "builtin",
          },
        ...
        (O.languages.kt = O.languages.kotlin),
        (O.languages.kts = O.languages.kotlin),
        (er.languages.c = er.languages.extend("clike", {
          comment: {
            pattern:
              /\/\/(?:[^\r\n\\]|\\(?:\r\n?|\n|(?![\r\n])))*|\/\*[\s\S]*?(?:\*\/|$)/,
            greedy: !0,
        ...
        er.languages.insertBefore("c", "string", {
          char: {
            pattern: /'(?:\\(?:\r\n|[\s\S])|[^'\\\r\n]){0,32}'/,
            greedy: !0,
          },
          ...
          macro: {
            ...
            inside: {
              string: [
                ...
                er.languages.c.string,
              ],
              char: er.languages.c.char,
              comment: er.languages.c.comment,
              "macro-name": [
              ...
              "directive-hash": /^#/,
              punctuation: /##|\\(?=[\r\n])/,
              expression: { pattern: /\S[\s\S]*/, inside: er.languages.c },
            },
          },
        }),
        er.languages.insertBefore("c", "function", {
          constant:
            /\b(?:EOF|NULL|SEEK_CUR|SEEK_END|SEEK_SET|__DATE__|__FILE__|__LINE__|__TIMESTAMP__|__TIME__|__func__|stderr|stdin|stdout)\b/,
        }),
        delete er.languages.c.boolean,
        (er.languages.objectivec = er.languages.extend("c", {
          string: {
            pattern: /@?"(?:\\(?:\r\n|[\s\S])|[^"\\\r\n])*"/,
            greedy: !0,
          },
        ...
        delete er.languages.objectivec["class-name"],
        (er.languages.objc = er.languages.objectivec),
        (er.languages.reason = er.languages.extend("clike", {
          string: {
            pattern: /"(?:\\(?:\r\n|[\s\S])|[^\\\r\n"])*"/,
            greedy: !0,
          },
        ...
        er.languages.insertBefore("reason", "class-name", {
          char: {
            pattern:
        ...
        delete er.languages.reason.function,
        (function (e) {
          for (
        ...
        (er.languages.go = er.languages.extend("clike", {
          string: {
            pattern: /(^|[^\\])"(?:\\.|[^"\\\r\n])*"|`[^`]*`/,
            lookbehind: !0,
            greedy: !0,
        ...
        er.languages.insertBefore("go", "string", {
          char: { pattern: /'(?:\\.|[^'\\\r\n]){0,10}'/, greedy: !0 },
        }),
        delete er.languages.go["class-name"],
        (R = er),
        (L =
        ...
        ((e, t) => {
          for (var n in t) Q(e, n, { get: t[n], enumerable: !0 });
        })(
          {},
          {
            dracula: () => ea,
      ...
      var ea = {
        ...
        ed = {
          ...
          styles: [
            { types: ["attr-name"], style: { color: eu.keyword } },
            { types: ["attr-value"], style: { color: eu.string } },
            {
              types: [
                "comment",
                "block-comment",
            ...
            },
            {
              ...
              style: { color: eu.primitive },
            },
            { types: ["boolean"], style: { color: eu.boolean } },
            { types: ["tag"], style: { color: eu.tag } },
            { types: ["string"], style: { color: eu.string } },
            { types: ["punctuation"], style: { color: eu.string } },
            {
              types: ["selector", "char", "builtin", "inserted"],
              style: { color: eu.char },
            },
            { types: ["function"], style: { color: eu.function } },
            {
              types: ["operator", "entity", "url", "variable"],
              style: { color: eu.variable },
            },
            { types: ["keyword"], style: { color: eu.keyword } },
            { types: ["atrule", "class-name"], style: { color: eu.className } },
      ...
      var ew = n(73),
        ...
        eE = X.forwardRef(function (e, t) {
          var n = ek(ek({}, X.useContext(ew.s)), e);
      ...
      n(7850);
      let eA = (e) => {
        let { className: t, title: n, children: r, footer: a, onClose: o } = e,
          s = (0, X.useRef)(null),
          i = (0, X.useRef)(null),
          l = (0, $.EM)(s),
          c = (0, $.EM)(i);
        return (0, _.jsx)($.LH, {
          ...
          children: (0, _.jsxs)("div", {
            ...
            children: [
              ...
              (0, _.jsxs)($.fS, {
                className: "jjk77a1",
                animated: (0, $.aa)("y", 16, 0),
                children: [
                  (0, _.jsx)($.LH, {
                    children: (0, _.jsxs)($.fS, {
                      className: "jjk77a2",
                      animated: (0, $.aa)("scaleY", 0.5, 1, 1),
                      children: [
                        (0, _.jsx)($.cA, {
                          elementRef: s,
                          className: "jjk77a3",
    ...
    3473: function (e, t, n) {
      ...
      let v = a.default.forwardRef(function (e, t) {
          ...
          let N = !1 !== x,
            ...
            $ = a.default.useContext(u.RouterContext),
            F = a.default.useContext(d.AppRouterContext),
            T = null != $ ? $ : F,
            M = !$,
            { href: I, as: P } = a.default.useMemo(() => {
              if (!$) {
                let e = b(i);
                return { href: e, as: y ? b(y) : e };
              }
              let [e, t] = (0, o.resolveHref)($, i, !0);
              return { href: e, as: y ? (0, o.resolveHref)($, y) : t || e };
            }, [$, i, y]),
            D = a.default.useRef(I),
            B = a.default.useRef(P);
          R && (r = a.default.Children.only(n));
          let z = R ? r && "object" == typeof r && r.ref : t,
            [W, U, H] = (0, p.useIntersection)({ rootMargin: "200px" }),
            G = a.default.useCallback(
              (e) => {
                (B.current !== P || D.current !== I) &&
                  (H(), (B.current = P), (D.current = I)),
                  W(e),
                  z &&
                    ("function" == typeof z
                      ? z(e)
          ...
          a.default.useEffect(() => {
            T && U && N && h(T, I, P, { locale: A }, { kind: _ }, M);
          }, [P, I, U, A, N, null == $ ? void 0 : $.locale, T, M, _]);
          let q = {
            ref: G,
            onClick(e) {
          ...
          if ((0, l.isAbsoluteUrl)(P)) q.href = P;
            ...
            let e = void 0 !== A ? A : null == $ ? void 0 : $.locale,
              t =
            ...
            q.href =
              t ||
              (0, g.addBasePath)(
                (0, c.addLocale)(P, e, null == $ ? void 0 : $.defaultLocale)
              );
          }
          return R
            ? a.default.cloneElement(r, q)
            : a.default.createElement("a", { ...L, ...q }, n);
        }),
        x = v;
      ("function" == typeof t.default ||
        ("object" == typeof t.default && null !== t.default)) &&
    ...
    6663: function (e, t, n) {
      ...
      let r = "undefined" != typeof window,
        ...
        v = (e) => (t) => {
          ...
          return Array.isArray(e)
            ? e.length
              ? n.map((t) => ("string" == typeof t ? t : b(e, t))).join(" ")
              : ""
            : n.map((t) => ("string" == typeof t ? t : e(t))).join(" ");
        },
        ...
        w = (e = []) => {
          ...
          return Object.freeze({ settings: e, up: n, down: r, between: a });
        },
        k = (e, t, n) => {
          let r = {};
          return (
            Object.keys(e).forEach((a) => {
              ...
              if ("object" == typeof e[a]) {
                if (null === e[a])
                  throw Error("Theme structure values can not be null.");
                if (!t[a] || "object" != typeof t[a])
                  throw Error(
                    "Theme default value should match theme structure object."
                  );
                r[a] = k(e[a], t[a], null == n ? void 0 : n[a]);
              } else
                r[a] =
                  null !== (o = null == n ? void 0 : n[a]) && void 0 !== o
                    ? o
                    : t[a];
            }),
            r
            ...
            Object.keys(e).forEach((r) => {
              if ("object" == typeof e[r]) n[r] = E(e[r], t[r]);
                ...
                switch (e[r]) {
                  ...
                  default:
                    throw Error(
                      `Invalid theme structure key "${e[r]}" provided.`
                    );
                }
            }),
            n
      ...
      function A(e = {}, t = {}) {
        for (let n in t)
          "object" != typeof t[n] || Array.isArray(t[n]) || null === t[n]
            ? (e[n] = t[n])
            : ((void 0 === e[n] || null === e[n]) && (e[n] = {}),
              A(e[n], t[n]));
        return e;
      }
      let j = {
        ...
        O = {
          ...
          transitions: { duration: "unit", durationN: "multiplier" },
        },
        C = (e) => ({
          main: (t) => [e, 80 + t, 92.5 - 9.44 * t],
          text: (t) => [e, 20 + t, 92.5 - 9.44 * t],
          deco: (t) => [e, 80 + t, 50, 0.025 + 0.025 * t],
          bg: (t) => [e, 20 + t, 2 + 2 * t],
          ol: (t) => [e, 80 + t, 2 + 2 * t],
        }),
        R = (e = {}) => {
          var t, n, r, a;
          let o =
              (null === (t = e.settings) || void 0 === t ? void 0 : t.dark) ===
                void 0 ||
              !!(null === (n = e.settings) || void 0 === n ? void 0 : n.dark),
            s = {
              primary: 200,
              secondary: 80,
              success: 120,
            ...
            l = {
              ...
              typography: {
                ...
                body: [
                  ...
                  { fontFamily: i.body, fontWeight: "400", fontSize: "1rem" },
                  {
                    fontFamily: i.body,
                    fontWeight: "400",
                    fontSize: "0.875rem",
                ...
                input: [
                  { fontFamily: i.input, fontWeight: "400", fontSize: "1rem" },
                  {
                    fontFamily: i.input,
                    fontWeight: "400",
                    fontSize: "0.875rem",
                ...
                code: [
                  { fontFamily: i.code, fontWeight: "400", fontSize: "1rem" },
                  {
                    fontFamily: i.code,
                    fontWeight: "400",
                    fontSize: "0.875rem",
            ...
            c = S(A(O, e.structure), A(l, e.settings)),
            u = c();
          return u;
        },
        L = Object.freeze({
        ...
        T = (e) => {
          let t = (t) => {
              ...
              return n.filter((e) => {
                let { condition: t } = e.control.getSettings();
                return !t || t(e);
              });
            },
            n = (e) => {
        ...
        M = (e, t) => {
          let n = 0,
            ...
            a = (t) => {
              ...
              let { duration: a } = e.control.getSettings(),
                o = n[n.length - 1];
            ...
            o = (a) => {
              ...
              t === _.staggerReverse && (o = o.reverse());
              let l = Date.now();
              for (let e of ((n = Math.max(n, l)), o)) {
                ...
                (n += i), e.scheduler.start(a + o, () => e.send(N.enter));
              }
            };
          return Object.freeze({
            name: t,
        ...
        I = (e, t) => {
          let n = 0,
            ...
            o = (e) => {
              let a = r(e),
                o = Date.now();
              for (let e of (t === _.sequenceReverse && (a = a.reverse()),
              (n = Math.max(n, o)),
              a)) {
                let t = e.control.getSettings(),
                  r = 1e3 * (t.duration.offset || 0),
                ...
                (n += a), e.scheduler.start(s + i, () => e.send(N.enter));
              }
            };
          return Object.freeze({
            name: t,
                    ...
                    ? o === n
                      ...
                      : (n
                          ? ((r = (t = n).subscribe((e) => {
                            ...
                            null == t || t.send(N.exit))
                          : (o.send(N.enter), (t = void 0)),
                        (n = o))
                    : ((t = n), (n = void 0));
                };
              t
                ...
                : s(),
                a.filter((e) => e !== o).forEach((e) => e.send(N.exit));
            },
            s = () => {
        ...
        D = (e, t) => {
          switch (t) {
            case _.stagger:
              return M(e, _.stagger);
            case _.staggerReverse:
              return M(e, _.staggerReverse);
            case _.sequence:
              return I(e, _.sequence);
            case _.sequenceReverse:
              return I(e, _.sequenceReverse);
            case _.switch:
              return P(e, _.switch);
            default:
              return T(e, _.parallel);
          }
        },
        B = (e, t) => {
          let n = t,
            a = {
              ...
              [L.entering]: {
                onEntry: {
                  execute: () => {
                    let { combine: t } = e.control.getSettings(),
                      n = t
                        ? Array.from(e.children)
                        : Array.from(e.children).filter(
                            (e) => e.control.getSettings().merge
                          );
                    e.manager.enterChildren(n);
                  },
                  schedule: () => {
                    let { duration: t } = e.control.getSettings();
                    return {
                ...
                onActions: {
                  [N.enterEnd]: L.entered,
                  [N.exit]: L.exiting,
                  [N.refresh]: () => {
                    let t = e.control.getSettings(),
                      n = Array.from(e.children).filter(
                        (e) => e.state === L.exited
                      );
              ...
              [L.entered]: {
                onEntry: {
                  execute: () => {
                    let { combine: t } = e.control.getSettings();
                    if (t) return;
                    let n = Array.from(e.children).filter(
                      (e) => !e.control.getSettings().merge
                    );
                    e.manager.enterChildren(n);
                  },
              ...
              [L.exiting]: {
                onEntry: {
                  execute: () => {
                    Array.from(e.children).forEach((e) => {
                      e.state === L.entering || e.state === L.entered
                        ? e.send(N.exit)
                        : e.state === L.exited && e.scheduler.stopAll();
                    });
                  },
                  schedule: () => ({
                ...
                onActions: { [N.exitEnd]: L.exited, [N.enter]: L.entering },
              },
              "*": {
                onActions: {
                  [N.update]: () => {
                    ...
                    if (
                      (a.manager !== e.manager.name &&
                        (null === (r = (t = e.manager).destroy) ||
                          void 0 === r ||
                          r.call(t),
                        (e.manager = D(e, a.manager))),
                      !e.parent)
                    ) {
                      let e = !0 === a.active || void 0 === a.active;
                      if ((n === L.exited || n === L.exiting) && e)
                        return L.entering;
                      if ((n === L.entered || n === L.entering) && !e)
                        return L.exiting;
                    }
                  },
                },
            ...
            o = (t) => {
              ...
              n = t;
              let { onEntry: r } = a[n] || {},
                { onTransition: o } = e.control.getSettings();
              if (
                (e.scheduler.stopAll(),
                (null == r ? void 0 : r.execute) && r.execute(),
                null == r ? void 0 : r.schedule)
              ) {
                let t = r.schedule();
                ...
                s(
                  null ===
                    (l =
                      null === (i = a["*"]) || void 0 === i
                        ? void 0
                        : i.onActions) || void 0 === l
                    ? void 0
                    : l[e]
                ));
            },
            l = Object.freeze({ getState: () => n, send: i });
          return l;
        },
        z = () => {
          let e;
          let t = `s${Math.random()}`.replace(".", ""),
            ...
            r = (e, r) => {
              let a = `${t}-n${n++}`,
                o = { id: a },
                i = r.getSettings(),
                l = B(o, i.initialState),
                c = D(o, i.manager),
                u = {
                  id: { value: a, enumerable: !0 },
                  control: { value: r, enumerable: !0 },
                  parent: { value: e, enumerable: !0 },
                  children: { value: new Set(), enumerable: !0 },
                  subscribers: { value: new Set(), enumerable: !0 },
                  scheduler: {
                    value: (function () {
                      let e = new Map(),
                        t = (t = s) => e.has(t),
                  ...
                  duration: {
                    get: () => {
                      let { duration: e, combine: t } = o.control.getSettings(),
                        n = t
                          ? o.manager.getDurationEnter(Array.from(o.children))
                          : e.enter || 0,
                        r = e.exit || 0;
                  ...
                  state: { get: () => l.getState(), enumerable: !0 },
                  subscribe: {
                    value: (e) => (
                      o.subscribers.add(e), e(o), () => o.subscribers.delete(e)
                    ),
                    enumerable: !0,
                  },
                  unsubscribe: {
                  ...
                  send: { value: l.send, enumerable: !0 },
                  manager: { value: c, enumerable: !0, writable: !0 },
                };
              return Object.defineProperties(o, u), e && e.children.add(o), o;
            },
            a = (e) => {
              for (let t of (e.scheduler.stopAll(), e.children)) a(t);
              e.parent && e.parent.children.delete(e),
                e.children.clear(),
                e.subscribers.clear();
            },
            o = (t, n) => {
              if (null == t) {
                if (e)
                  throw Error(
                    "The root node must be unregistered before registering another root node."
                  );
                return (e = r(void 0, n));
              }
              if (!e)
          ...
          return (
            Object.defineProperties(l, {
              ...
              root: { get: () => e, enumerable: !0 },
              register: { value: o, enumerable: !0 },
              unregister: { value: i, enumerable: !0 },
            }),
            l
          );
        },
        ...
        X = {
          ...
          inQuad: (e) => e * e,
          outQuad: (e) => 1 - (1 - e) * (1 - e),
          inOutQuad: (e) => (e < 0.5 ? 2 * e * e : 1 - W(-2 * e + 2, 2) / 2),
          inCubic: (e) => e * e * e,
          outCubic: (e) => 1 - W(1 - e, 3),
          inOutCubic: (e) =>
            e < 0.5 ? 4 * e * e * e : 1 - W(-2 * e + 2, 3) / 2,
          inQuart: (e) => e * e * e * e,
          outQuart: (e) => 1 - W(1 - e, 4),
          inOutQuart: (e) =>
            e < 0.5 ? 8 * e * e * e * e : 1 - W(-2 * e + 2, 4) / 2,
          inQuint: (e) => e * e * e * e * e,
          outQuint: (e) => 1 - W(1 - e, 5),
          inOutQuint: (e) =>
            e < 0.5 ? 16 * e * e * e * e * e : 1 - W(-2 * e + 2, 5) / 2,
          inSine: (e) => 1 - G((e * q) / 2),
          outSine: (e) => H((e * q) / 2),
          ...
          inOutBack: (e) =>
            e < 0.5
              ? (W(2 * e, 2) * (7.189819 * e - 2.5949095)) / 2
              : (W(2 * e - 2, 2) * (3.5949095 * (2 * e - 2) + 2.5949095) + 2) /
                2,
          inElastic: (e) =>
            0 === e
              ? 0
              : 1 === e
              ? 1
              : -W(2, 10 * e - 10) * H((10 * e - 10.75) * Z),
          outElastic: (e) =>
            0 === e
              ? 0
              : 1 === e
              ? 1
              : W(2, -10 * e) * H((10 * e - 0.75) * Z) + 1,
          inOutElastic: (e) =>
            0 === e
              ? 0
              : 1 === e
              ? 1
              : e < 0.5
              ? -(W(2, 20 * e - 10) * H((20 * e - 11.125) * Y)) / 2
              : (W(2, -20 * e + 10) * H((20 * e - 11.125) * Y)) / 2 + 1,
          inBounce: (e) => 1 - V(1 - e),
          outBounce: V,
          inOutBounce: (e) =>
            e < 0.5 ? (1 - V(1 - 2 * e)) / 2 : (1 + V(2 * e - 1)) / 2,
        },
        K = (e) => {
          let {
              duration: t,
          ...
          return { isPending: () => null !== c, cancel: f };
        },
        Q = (e) => {
          var t;
          ...
          let {
            ...
            x = () => {
              ...
              if (!t) {
                (p = !0),
                  console.error(
                    `The bleep sources "${JSON.stringify(
                      o
                    )}" are not supported on this navigator.`
                  );
                return;
              }
              let { src: n, type: r } = t;
              (d = !0),
                window
                  .fetch(n, { method: "GET", headers: c })
                  .then((e) => {
                    if (!e.ok)
                      throw Error("Bleep source could not be fetched.");
                    return e;
                  })
                  .then((e) => e.arrayBuffer())
                  .then((e) => h.decodeAudioData(e))
                  .then((e) => {
                    y = (m = e).duration;
                  })
                  .catch((e) => {
                    (p = !0),
                      console.error(
                        `The bleep with source URL "${n}" and type "${r}" could not be used:`,
                        e
                      );
                  })
                  .then(() => (d = !1));
            ...
            w = (e) => {
              ...
              if (!i || !f) {
                ...
                e && v.add(e),
                  (f = !0),
                  g && (g.stop(), g.disconnect(b), (g = null)),
                  ((g = h.createBufferSource()).buffer = m),
                  (g.loop = i),
                  i && ((g.loopStart = 0), (g.loopEnd = m.duration)),
                  g.connect(b),
                  g.start(),
                  (g.onended = () => {
                    f = !1;
            ...
            A = (e) => {
              if (void 0 !== e.volume) {
                ...
                b.gain.setValueAtTime(t, h.currentTime);
              }
            },
            j = {};
          return (
            Object.defineProperties(j, {
              duration: { get: () => y, enumerable: !0 },
              isPlaying: { get: () => f, enumerable: !0 },
              isLoaded: { get: () => !!m, enumerable: !0 },
              play: { value: w, enumerable: !0 },
              stop: { value: k, enumerable: !0 },
              load: { value: E, enumerable: !0 },
              unload: { value: S, enumerable: !0 },
              update: { value: A, enumerable: !0 },
            }),
            u ? b.connect(u) : b.connect(h.destination),
            A({ volume: l }),
            s && x(),
            j
          );
          ...
          if (
            ...
            let r = Math.max(
              ...
              Math.min(
                ...
                null !==
                  (n =
                    null === (t = null == e ? void 0 : e.master) || void 0 === t
                      ? void 0
                      : t.volume) && void 0 !== n
                  ? n
                  : 1
              ...
              if (a) {
                ...
                l.forEach((n) => {
                  ...
                  let u = e.bleeps[n],
                    ...
                    p = d
                      ? null === (r = t.categories) || void 0 === r
                        ? void 0
                        : r[d]
                      : null,
                    f = { ...t.common, ...p };
                  f.disabled
                    ? (null === (a = i[n]) || void 0 === a || a.unload(),
                      (i[n] = null))
                    : i[n]
                    ? null === (l = i[n]) ||
                      void 0 === l ||
                      l.update({
                        ...f,
                        ...(null === (c = t.bleeps) || void 0 === c
                          ? void 0
                          : c[n]),
                      })
                    : (i[n] = Q({ ...f, ...u, context: o, masterGain: s }));
                });
              }
            };
          return Object.freeze({ bleeps: i, unload: c, update: u });
        },
        ee = {
          duration: 0.3,
          delay: 0,
      ...
      let eo = (e) => e(),
        es = (e, t, n = ee.duration) =>
          new Proxy(
            { animations: e.map(eo).filter(Boolean), duration: n, options: t },
            el
          ),
        ei = (e) => e.animations[0],
        el = {
          get: (e, t) => {
            ...
            switch (t) {
              ...
              case "finished":
                return (
                  e.finished ||
                    (e.finished = Promise.all(e.animations.map(ec)).catch(en)),
                  e.finished
                );
              case "stop":
                return () => {
      ...
      function eb(e, t) {
        return ep(e) ? e[eh(0, e.length, t)] : e;
      }
      ...
      function ew(e, t, n, r) {
        ...
        let a = (t) =>
          (function (e, t, n, r, a) {
            ...
            let i = 0;
            do
              (o = ex((s = t + (n - t) / 2), r, a) - e) > 0 ? (n = s) : (t = s);
            while (Math.abs(o) > 1e-7 && ++i < 12);
            return s;
          })(t, 0, 1, e, n);
      ...
      let ek =
        ...
        eA = {
          ease: ew(0.25, 0.1, 0.25, 1),
          "ease-in": ew(0.42, 0, 1, 1),
          "ease-in-out": ew(0.42, 0, 0.58, 1),
          "ease-out": ew(0, 0, 0.58, 1),
        },
        ej = /\((.*?)\)/;
      function eO(e) {
        if (eE(e)) return e;
      ...
      class eC {
        constructor(
          ...
          (this.repeat = s),
            (this.easing = ep(n) ? er : eO(n)),
            this.updateDuration(r);
          let c = (function (e, t = ey(e.length), n = er) {
            let r = e.length,
              a = r - t.length;
            return (
              a > 0 && em(t, a),
          ...
          (this.tick = (t) => {
            ...
            let g =
              void 0 === this.pauseTime &&
              ("finished" === this.playState || r >= this.totalDuration + o);
            g
      ...
      let eM = ["", "X", "Y", "Z"],
        eI = { x: "translateX", y: "translateY", z: "translateZ" },
        eP = {
          syntax: "<angle>",
          initialValue: "0deg",
      ...
      ["translate", "scale", "rotate", "skew"].forEach((e) => {
        eM.forEach((t) => {
          eW.push(e + t), eB.set(ez(e + t), eD[e]);
        });
      });
      let eU = (e, t) => eW.indexOf(e) - eW.indexOf(t),
        ...
        eq = (e, t) => {
          var n;
          eI[t] && (t = eI[t]);
          let { transforms: r } = eT(e);
          (n = t),
            -1 === r.indexOf(n) && r.push(n),
            (e.style.transform = eZ(r));
        },
        eZ = (e) => e.sort(eU).reduce(eY, "").trim(),
        eY = (e, t) => `${e} ${t}(var(${ez(t)}))`,
        eV = (e) => e.startsWith("--"),
        eX = new Set(),
        ...
        eQ = {
          ...
          finished: () =>
            !!eK({ opacity: [0, 1] }, { duration: 0.001 }).finished,
          linearEasing: () => {
            try {
              eK({ opacity: 0 }, { easing: "linear(0, 1)" });
            } catch (e) {
              return !1;
            }
            return !0;
        ...
        e0 = {};
      for (let e in eQ)
        e0[e] = () => (void 0 === eJ[e] && (eJ[e] = eQ[e]()), eJ[e]);
      let e1 = (e, t) => {
          let n = "",
            r = Math.round(t / 0.015);
      ...
      function e4(e) {
        return eI[e] && (e = eI[e]), eG(e) ? ez(e) : e;
      }
      let e6 = {
          get: (e, t) => {
            let n = eV((t = e4(t)))
          ...
          set: (e, t, n) => {
            eV((t = e4(t))) ? e.style.setProperty(t, n) : (e.style[t] = n);
          },
        },
      ...
      function e7(e, t, n, r = {}, a) {
        ...
        v && eq(e, t);
        let w = e4(t),
          k = ((o = b.values).has(w) || o.set(w, new e$()), o.get(w)),
          E = eB.get(w);
        return (
          ea(k.animation, !(eu(f) && k.generator) && !1 !== r.record),
          () => {
            let o = () => {
                var t, n;
                return null !==
                  (n =
                    null !== (t = e6.get(e, w)) && void 0 !== t
                      ? t
                      : null == E
                      ? void 0
                      : E.initialValue) && void 0 !== n
                  ? n
                  : 0;
              },
              b = (function (e, t) {
            ...
            if (
              (eV(w) &&
                (e0.cssRegisterProperty()
                  ? (function (e) {
                      if (!eX.has(e)) {
                        eX.add(e);
                        try {
                          let { syntax: t, initialValue: n } = eB.has(e)
                            ? eB.get(e)
                            : {};
              ...
              E && (b = b.map((e) => (ed(e) ? E.toDefaultUnit(e) : e))),
                1 === b.length &&
                  (!e0.partialKeyframes() || l) &&
                  b.unshift(o());
              let t = {
                delay: et.ms(u),
                duration: et.ms(c),
              ...
              s.finished
                ...
                .catch(en),
                h || (s.playbackRate = 1.000001);
            } else if (a && v)
              1 ===
                (b = b.map((e) => ("string" == typeof e ? parseFloat(e) : e)))
                  .length && b.unshift(parseFloat(o())),
                (s = new a(
                  (t) => {
                    e6.set(e, w, S ? S(t) : t);
                  },
            ...
            return (
              l &&
                i(
                  ...
                  t,
                  b,
                  { duration: c, delay: u, easing: f, repeat: p, offset: y },
                  "motion-one"
                ),
              k.setAnimation(s),
              s
      ...
      let tt = function (e, t, n = {}) {
        e = te(e);
        let r = e.length;
        e_(!!r, "No valid element provided."), e_(!!t, "No keyframes defined.");
        let a = [];
        for (let i = 0; i < r; i++) {
          let l = e[i];
          for (let e in t) {
      ...
      let ta = (e, t) => {
          Array.from(e.childNodes).forEach((e) => {
            e.nodeType === Node.TEXT_NODE
              ? t(e)
              : e.nodeType === Node.ELEMENT_NODE && ta(e, t);
          });
        },
        to = (e, t, n) => {
          let r = 0;
        ...
        ts = (e) => {
          ...
          if (!t || !n) return { isPending: () => !1, cancel: () => {} };
          let l = n.cloneNode(!0);
          ...
          let f = tr(
            ...
            { duration: 0.1, easing: "steps(2, end)", repeat: 1 / 0 }
          );
          return K({
            duration: r,
            easing: a,
        ...
        ti =
          "abcdefghijklmn\xf1opqrstuvwxyzABCDEFGHIJKLMN\xd1OPQRSTUVWXYZ>!\xb7$%&/()=?\xbf≤|@#",
        tl = (e) => {
          let {
            rootElement: t,
            contentElement: n,
                  ...
                  e
                    ...
                    .map((e, t) =>
                      " " === e
                        ...
                        : g[t]
                        ? e
                        : ti[Math.round(Math.random() * (ti.length - 1))]
                    )
                    .join("")
                );
                to(u, n, p);
        ...
        tc = (e) => {
          let { length: t, maxDuration: n = 4, cps: r = 400 } = e;
      ...
      let tp = (e, t) => (0, tu.memo)(e, t),
        ...
        th = (e) => {
          let {
            ...
            p = (0, tu.useContext)(tg),
            f = (0, tu.useContext)(tm),
            g = (0, tu.useRef)(d),
            m = (0, tu.useRef)(null),
            y = (0, tu.useRef)(null),
            h = (0, tu.useRef)(void 0),
            b = (0, tu.useRef)(!0),
            v = (0, tu.useRef)(!0);
          g.current = d;
          let x = null == f ? void 0 : f.getSettings(),
            ...
            S = (0, tu.useMemo)(() => {
              if ((h.current && h.current.system.unregister(h.current.node), k))
                return ty(c, null), p;
              if (E) {
                ty(c, null);
                return;
              ...
              let e = w ? z() : p.system,
                ...
                a = Object.freeze({
                  ...
                  getForeignRef: () => y.current,
                  setForeignRef: r,
                }),
                o = w ? e.register(void 0, a) : e.register(p.node, a);
              return ty(c, o), Object.freeze({ system: e, node: o });
            }, [p, w, E, k]);
          h.current = S;
          let [A, j] = (0, tu.useState)(
            () =>
              (a && (null == S ? void 0 : S.node.state) === L.exited) ||
              (o && (null == S ? void 0 : S.node.state) === L.entered) ||
              (s && E)
          );
          return (
            (0, tu.useEffect)(
              () => () => {
                h.current && h.current.system.unregister(h.current.node);
              },
              []
            ),
            (0, tu.useEffect)(() => {
              null == S || S.node.send(N.setup);
            }, [!!S]),
            (0, tu.useEffect)(() => {
              if (b.current) {
                b.current = !1;
              ...
              null == S || S.node.send(N.update);
            }, [d.active, d.manager, d.merge, d.combine]),
            (0, tu.useEffect)(() => {
              if (S) {
                let e = S.node.subscribe((e) => {
                  j(
                    (a && e.state === L.exited) || (o && e.state === L.entered)
                  );
                });
                return () => e();
              }
            ...
            (0, tu.useEffect)(
              () => {
                ...
                S && S.node.send(null != i ? i : N.refresh);
              },
              null != l ? l : []
            ),
            (0, tu.createElement)(tg.Provider, { value: S }, A ? null : u)
          );
        },
        tb = tp(th),
        ...
        tx = (e) => {
          ...
          r.current = n;
          let a = (0, tu.useMemo)(
            () => Object.freeze({ getSettings: () => r.current }),
            []
          );
          return (0, tu.createElement)(tm.Provider, { value: a }, t);
        },
        tw = tp(tx);
      Object.freeze({});
      let tk = { x: "translateX", y: "translateY", z: "translateZ" },
        tE = {
          rotate: "rotate",
          rotateX: "rotateX",
          rotateY: "rotateY",
        ...
        tj = (e) => {
          ...
          let {
            ...
            d = tv(),
            p = (0, tu.useMemo)(() => r || "div", []),
            f = (0, tu.useRef)(null),
            g = (0, tu.useRef)([]),
            m = (0, tu.useRef)([]),
            [y, h] = (0, tu.useState)(
              () => (null == d ? void 0 : d.node.state) === L.exited
            ),
            [b, v] = (0, tu.useState)(
              () => (null == d ? void 0 : d.node.state) === L.entered
            ),
          ...
          return (
            ...
            (0, tu.useEffect)(() => {
              ...
              let e = d.node.subscribe((e) => {
                ...
                n.map((t) => {
                  var n;
                  return null === (n = t.transitions) || void 0 === n
                    ? void 0
                    : n[e.state];
                })
                  .filter(Boolean)
            ...
            d &&
              (t = w
                .map((e) => (null == e ? void 0 : e.initialAttributes))
                .reduce((e, t) => ({ ...e, ...t }), {})),
            d &&
              (n = w
                .map((e) => tA(null == e ? void 0 : e.initialStyle))
                .reduce((e, t) => ({ ...e, ...t }), {})),
            (0, tu.createElement)(p, {
              ...u,
              ...t,
              className: o,
              style: {
                ...s,
                ...n,
                visibility: d && ((l && y) || (c && b)) ? "hidden" : "visible",
              },
              ref: tf(i, f),
            })
          );
        ...
        tO = (0, tu.memo)(
          (0, tu.forwardRef)((e, t) =>
            (0, tu.createElement)(tj, { elementRef: t, ...e })
          )
        ),
        tC = (e) => {
          let t, n;
              ...
              if (e)
                return (
                  t
                    .map((e) => {
                      var t;
                      return null === (t = e.transitions) || void 0 === t
                        ? void 0
                        : t[a];
                    })
                    .filter(Boolean)
      ...
      (0, tu.memo)(
        (0, tu.forwardRef)((e, t) =>
          (0, tu.createElement)(tC, { elementRef: t, ...e })
        )
      );
      function tR(e, t, n, r) {
        var a;
      ...
      function tN(e, t = {}) {
        ...
        let r = (function (e, t = {}) {
            ...
            for (let t = 0; t < e.length; t++) {
              ...
              if (!Array.isArray(i)) {
                d.set(i.name, tR(f, i.at, p, d));
                continue;
              }
              let [l, m, y = {}] = i;
              void 0 !== y.at && (f = tR(f, y.at, p, d));
              let h = 0,
                b = te(l, u),
                v = b.length;
              for (let e = 0; e < v; e++) {
                ...
                for (let t in m) {
                  ...
                  let b = ((a = y.delay), (o = e), (eE(a) ? a(o, v) : a) || 0),
                    x = f + b,
                    w = x + d,
                    { offset: k = ey(c.length) } = u;
              ...
              c.forEach((e, t) => {
                for (let n in e) {
                  ...
                  for (let e = 0; e < r.length; e++) {
                    let { at: t, value: n, easing: s } = r[e];
                    a.push(n), o.push(eg(0, g, t)), c.push(s || ee.easing);
                  }
                  0 !== o[0] &&
                    (o.unshift(0), a.unshift(a[0]), c.unshift("linear")),
                    1 !== o[o.length - 1] && (o.push(1), a.push(null)),
                    l.push([
                      t,
                      n,
                      a,
        ...
        return es(
          a,
          t,
          null === (n = r[0]) || void 0 === n ? void 0 : n[3].duration
        );
      }
      let t_ = (e, t, n, r) => ({
          transitions: {
            entering: { [e]: [t, n] },
            exiting: { [e]: [n, null != r ? r : t] },
          },
        }),
        t$ = () => t_("opacity", 0, 1),
        tF = () => ({
          transitions: {
            entering: ({ element: e, duration: t }) =>
              tN(
                [
                  [e, { opacity: [0, 1] }],
                  [e, { opacity: [1, 0.7] }],
        ...
        tM = (e) => {
          let {
            ...
            s = (0, tu.useMemo)(
              () => J({ master: t, common: n, categories: r, bleeps: a }),
              []
            );
          return (
            (0, tu.useEffect)(() => {
              null == s ||
                s.update({ master: t, common: n, categories: r, bleeps: a });
            }, [t, n, r, a]),
            (0, tu.useEffect)(
              () => () => {
                null == s || s.unload();
            ...
            tu.createElement(tT.Provider, { value: s }, o)
          );
        },
        tI = tp(tM),
        tP = {},
        tD = (e = tP) => {
          ...
          let n = (0, tu.useContext)(tT);
          return null !== (t = null == n ? void 0 : n.bleeps) && void 0 !== t
            ? t
            : {};
        };
      var tB = (function () {
      ...
      function t8(e) {
        return (tX = tK = 1), (tQ = tY((t1 = e))), (tJ = 0), [];
      }
      function t7(e) {
        var t, n;
        return ((t = tJ - 1),
      ...
      function nl(e, t, n, r, a, o, s, i, l, c, u) {
        for (
          ...
          for (
            var h = 0, b = tZ(e, d + 1, (d = tz((m = s[g])))), v = e;
            h < f;
            ++h
          )
            (v = (m > 0 ? p[h] + " " + b : tH(b, /&\f/g, p[h])).trim()) &&
              (l[y++] = v);
      ...
      var nu = function (e, t, n) {
        ...
        ng = function (e) {
          if ("rule" === e.type && e.parent && !(e.length < 1)) {
            ...
            if (
              ...
              nf.set(e, !0);
              for (
                var a = [], o = np(t, a), s = n.props, i = 0, l = 0;
                i < o.length;
                i++
              )
                ...
                case na:
                  e.return = (function e(t, n) {
                    switch (
                      ...
                      case 5292:
                        return (
                          nt + t + t9 + tH(t, "basis", "preferred-size") + t
                        );
                      case 6060:
                        return (
                          nt +
                      ...
                      case 4765:
                        if (tY(t) - 1 - n > 6)
                          switch (tq(t, n + 1)) {
                            ...
                            case 115:
                              return ~tG(t, "stretch")
                                ? e(tH(t, "stretch", "fill-available"), n) + t
                                : t;
                          }
                        break;
                      case 4949:
                  ...
                  break;
                case no:
                  return ns([t5(e, { value: tH(e.value, "@", "@" + nt) })], r);
                case nr:
                  if (e.length)
                    return e.props
                      .map(function (t) {
        ...
        nA =
          ...
          function (e) {
            return (
              void 0 === eR[e] &&
                (eR[e] = nE(e) ? e : e.replace(nw, "-$&").toLowerCase()),
              eR[e]
            );
          }),
        nj = function (e, t) {
          switch (e) {
            ...
            case "animationName":
              if ("string" == typeof t)
                return t.replace(nk, function (e, t, n) {
                  return (eN = { name: t, styles: n, next: eN }), t;
                });
          }
          return 1 === nx[e] || nE(e) || "number" != typeof t || 0 === t
            ? t
            : t + "px";
        };
      function nO(e, t, n) {
      ...
      var nC = /label:\s*([^\s;\n{]+)\s*(;|$)/g,
        nR = function (e, t, n) {
          ...
          for (var i = 1; i < e.length; i++)
            (o += nO(n, t, e[i])), a && (o += s[i]);
          nC.lastIndex = 0;
          for (var l = ""; null !== (r = nC.exec(o)); ) l += "-" + r[1];
          return { name: nv(o) + l, styles: o, next: eN };
        },
        nL = !!td.useInsertionEffect && td.useInsertionEffect,
        nN =
          nL ||
          function (e) {
            return e();
          };
      nL || tu.useLayoutEffect;
      var n_ = {}.hasOwnProperty,
        n$ = (0, tu.createContext)(
            ...
            ? (function (e) {
                ...
                var d =
                  ...
                  p = function (e) {
                    var t, n;
                    return ns(
                      ((n = (function e(t, n, r, a, o, s, i, l, c) {
                        for (
                          var u,
                            d = 0,
                            p = 0,
                              ...
                              switch (x) {
                                ...
                                default:
                                  if (
                                    ...
                                    if (0 === p) e(A, n, S, S, k, s, f, l, E);
                                    else
                                      switch (
                                        99 === g && 110 === tq(A, 3) ? 100 : g
                                      ) {
                                        case 100:
                                        case 109:
                                        case 115:
      ...
      n$.Provider;
      var nF = (0, tu.createContext)({}),
        nT = "__EMOTION_TYPE_PLEASE_DO_NOT_USE__",
        nM = function (e, t) {
          var n = {};
          for (var r in t) n_.call(t, r) && (n[r] = t[r]);
          return (n[nT] = e), n;
        },
        nI = function (e) {
          var t = e.cache,
        ...
        nP =
          ((eL = function (e, t, n) {
            ...
            var u = nR(l, void 0, (0, tu.useContext)(nF));
            c += t.key + "-" + u.name;
            var d = {};
            for (var p in e)
              n_.call(e, p) && "css" !== p && p !== nT && (d[p] = e[p]);
            return (
              (d.ref = n),
              (d.className = c),
              (0, tu.createElement)(
          ...
          (0, tu.forwardRef)(function (e, t) {
            return eL(e, (0, tu.useContext)(n$), t);
          }));
      n(3463);
      var nD = function (e, t) {
        var n = arguments;
        if (null == t || !n_.call(t, "css"))
          return tu.createElement.apply(void 0, n);
        var r = n.length,
          a = Array(r);
        (a[0] = nP), (a[1] = nM(e, t));
      ...
      let nB = "codacom-react-text-text",
        nz = (e) => {
          let {
            ...
            v = tv(),
            [x, w] = (0, tu.useState)(
              () => (null == v ? void 0 : v.node.state) === L.exited
            ),
            [k, E] = (0, tu.useState)(
              () => (null == v ? void 0 : v.node.state) === L.entered
            );
          return (
            (0, tu.useEffect)(() => {
              var e, t;
            ...
            (0, tu.useEffect)(() => {
              if (!v) {
                h.current && (h.current.style.visibility = "visible");
                return;
              }
              if (!g.length) return;
              if (!l) {
                let e = v.node.control.getSettings(),
                  t = tc({ length: g.length, maxDuration: e.duration.enter }),
                  n = tc({ length: g.length, maxDuration: e.duration.exit });
                v.node.control.setDynamicSettings({
                  duration: { enter: t, exit: n },
                });
              }
              let e = "decipher" === s ? tl : ts,
                t = (t, n) => {
                  var r;
                  null === (r = b.current) || void 0 === r || r.cancel(),
                    (b.current = e({
                      rootElement: y.current,
                      contentElement: h.current,
                      duration: t,
                      isEntering: n,
                      easing: i,
                      hideOnExited: c,
                ...
                n = v.node.subscribe((e) => {
                  switch (
                    (E(e.state === L.entered), w(e.state === L.exited), e.state)
                  ) {
                    case "entered":
            ...
            nD(
              ...
              nD(
                ...
                {
                  ref: h,
                  className: o(`${nB}__content`, r),
                  css: {
                    position: "relative",
                    zIndex: 1,
                    display: "inline-block",
                    visibility:
                      v && ((u && k) || (c && x)) ? "hidden" : "visible",
                  },
                },
                a
              )
        ...
        nU = (e, t) => {
          (0, tu.useEffect)(() => {
            ...
            let n = e.current,
              r = () => {
                let { width: e, height: r } = n.getBoundingClientRect();
        ...
        nH = (e) => {
          ...
          (0, tu.useEffect)(() => {
            ...
            let s = t.node.subscribe((e) => {
              ...
              let { duration: r } = e;
              switch (
                (null === (t = n.current) || void 0 === t || t.cancel(),
                e.state)
              ) {
                case "exited":
                  a.concat(o).forEach((e) => {
          ...
          let r = (0, tu.useCallback)(() => {
            ...
            let a = e.current,
              ...
              i = t.node.state === L.entering || t.node.state === L.entered;
            null === (r = n.current) || void 0 === r || r.cancel(),
              o.concat(s).forEach((e) => {
        ...
        nq = (e, t, n) => {
          if (Array.isArray(n)) {
            ...
            if ("A" === r || "a" === r) {
              let [n, o, s, i, l, c, u] = a,
                d = [nG(e, n), nG(t, o), s, i, l, nG(e, c), nG(t, u)].join(",");
              return r + " " + d;
            }
        ...
        nY = (e, t, n, r) => {
          ...
          for (let o = 0; o < r.length; o++) {
            ...
            if (
              ((l.dataset.frame = ""),
              Object.assign(l.style, { vectorEffect: "non-scaling-stroke" }),
              !c)
            ) {
              let { name: e, id: t, className: n, style: r } = s;
              l.dataset.name !== e && (l.dataset.name = e),
                l.id !== t && (l.id = t || ""),
                l.classList.value !== n && (l.classList.value = n || ""),
                Object.assign(l.style, r);
            }
            l.setAttribute("d", nZ(t, n, u)),
              l.parentNode !== e && e.appendChild(l);
          }
        },
        nV = (e) => {
          let {
            ...
            d = (0, tu.useMemo)(() => {
              let e = i / 2,
                ...
                m = [
                  {
                    name: "bg",
                    style: { strokeWidth: 0, fill: "currentcolor" },
                    path: f.concat(g),
                  },
                  { name: "line", style: o, path: f },
                  { name: "line", style: o, path: g },
                ];
              return m;
            }, [t, n, r, a, s, i, l]);
          ...
          let {
            ...
            i = (0, tu.useMemo)(() => {
              ...
              return [
                ...
                ...s.map((n) => ({
                  name: "line",
                  style: { ...e, strokeWidth: String(t) },
                  path: n,
                })),
                ...i.map((t) => ({
                  name: "line",
                  style: { ...e, strokeWidth: String(n) },
                  path: t,
                })),
              ];
            }, [t, n, r]);
            ...
            c = (0, tu.useMemo)(() => {
              let e = n / 2,
                ...
                c = [
                  ...
                  { name: "line", style: o, path: n3(i) },
                  { name: "line", style: o, path: n3(l) },
                ];
              return c;
            }, [r, a, t, n, s]);
          return tu.createElement(nX, {
            ...
            c = (0, tu.useMemo)(() => {
              let e = n / 2,
                ...
                c = [
                  ...
                  { name: "line", style: o, path: n8(i) },
                  { name: "line", style: o, path: n8(l) },
                ];
              return c;
            }, [r, a, t, n, s]);
          return tu.createElement(nX, {
          ...
          return (
            (0, tu.useEffect)(() => {
              ...
              let a = (e) => {
                  ...
                  (t.style.opacity = "1"),
                    t.setAttribute("cx", String(o)),
                    t.setAttribute("cy", String(s));
                },
                o = () => {
                  t.style.opacity = "0";
                };
              return (
                ...
                () => {
                  document.removeEventListener("mousemove", a),
                    document.removeEventListener("mouseleave", o);
                }
              );
            }, [t, n]),
            tu.createElement(
              ...
              tu.createElement(
                ...
                tu.createElement(
                  "radialGradient",
                  { id: s },
                  tu.createElement("stop", { offset: "0%", stopColor: t }),
      ...
      let rt = (e) => {
              ...
              let e = s.current,
                ...
                n = (n) => {
                  let r = t.getBoundingClientRect(),
                    ...
                    o = n.clientY - r.top;
                  (e.style.opacity = "1"),
                    (e.style.transform = `translate(calc(${a}px - 50%), calc(${o}px - 50%))`);
                },
                r = () => {
                  e.style.opacity = "0";
                };
              return (
                ...
                () => {
                  document.removeEventListener("mousemove", n),
                    document.removeEventListener("mouseleave", r);
                }
              );
            }, []),
        ...
        ra = (e, t, n, r, a) => {
          ...
          let [o, s] = a,
            ...
            l = t * s,
            c = rr(n, r, i, l),
            u = rr(i, l, i < e / 2 ? e : 0, l < t / 2 ? t : 0);
          return c / u;
        },
        { entering: ro, exiting: rs } = L,
        ri = {
          color: "#777",
          type: "box",
          distance: 30,
        ...
        rl = (e) => {
          let t = { ...ri, ...e },
            { elementRef: n, className: r, style: a } = t,
            s = tv(),
            i = (0, tu.useRef)(null),
            l = (0, tu.useRef)(t);
          return (
            ...
            (0, tu.useEffect)(() => {
              ...
              let n = () => {
                ...
                r = (r) => {
                  ...
                  n();
                  let a = r.state === ro,
                    { duration: o } = r.control.getSettings(),
                    s =
                      (a
                        ? null == o
                          ? void 0
                      ...
                      for (let l = 0; l < f; l++) {
                        ...
                        for (let l = 0; l < g; l++) {
                          let f = y / 2 + l * r,
                            ...
                            m = (a && i) || (!a && !i) ? 1 - g : g,
                            h = e / m,
                            b = Math.max(0, Math.min(1, h));
                          u.beginPath(),
                            (u.globalAlpha = a ? b : 1 - b),
                            "box" === n
                              ? u.rect(c - o / 2, f - o / 2, o, o)
                              : u.arc(c, f, o, 0, 2 * Math.PI),
                            (u.fillStyle = t),
                            u.fill(),
                            u.closePath();
                        }
                  ...
                  (e = tr(d, { duration: s, easing: "ease-in-out" })),
        ...
        rc = tp(rl),
        { entering: ru, entered: rd, exiting: rp, exited: rf } = L,
          ...
          return (
            ...
            (0, tu.useEffect)(() => {
              ...
              let r = i.current,
                ...
                c = (s) => {
                  let i = s.state,
                    { duration: c } = s.control.getSettings();
                  switch (i) {
                    case ru: {
                      o();
                      let {
                        ...
                        t = tr(
                          (e) => {
                            if ((k(e), e >= 1)) {
                              let e =
                                1e3 *
                                ((null == c ? void 0 : c.intervalPause) || 0);
          ...
          return (
            ...
            (0, tu.useEffect)(() => {
              ...
              let n = i.current,
                ...
                o = (t) => {
                  let r = t.state,
                    { duration: o } = t.control.getSettings();
                  switch (r) {
                    case rb:
                      a(),
                        (e = tr(
              ...
              return (
                s.node.subscribers.add(o),
                window.ResizeObserver &&
                  !t &&
                  (t = new window.ResizeObserver(() => a())).observe(n),
                () => {
                  s.node.subscribers.delete(o),
                    null == e || e.cancel(),
                    null == t || t.disconnect();
                }
              );
      ...
      tp(rw);
      let { entering: rk, exiting: rE, exited: rS } = L,
        rA = (e, t) => (t - e) * Math.random(),
        rj = (e) => Math.min(1, Math.max(0, 1 === e ? 1 : e % 1)),
        rO = (e) => {
          let { distance: t, positionsLength: n, margin: r, size: a } = e,
            o = Math.floor(rA(0.1, 0.5) * n),
            s = Array(n)
              .fill(0)
              .map((e, t) => t),
            l = i(s),
        ...
        rC = { lineWidth: 1, lineColor: "#777", distance: 30, sets: 5 },
        rR = (e) => {
          let t = { ...rC, ...e },
            { elementRef: n, className: r, style: a } = t,
            s = tv(),
          ...
          return (
            ...
            (0, tu.useEffect)(() => {
              ...
              let n = i.current,
                  ...
                  (n.width = c),
                    ...
                    a.forEach((t, n) => {
                      let a = rj(e + (1 / i) * n),
                        o = X.inOutCubic(a);
                      t.forEach((e) => {
                        let { axis1: t, axis2Initial: n, length: a } = e,
                          s = 2 * u * o - u;
                        r.beginPath(),
                          r.moveTo(t, u - (n + s)),
                          r.lineTo(t, u - (n + a + s)),
                ...
                c = (r) => {
                  let a = r.state,
                    { duration: s } = r.control.getSettings();
                  switch (a) {
                    case rk:
                      (e = tr(
                        n,
                        { opacity: [0, 1] },
                        { duration: s.enter, easing: "ease-out" }
                      )),
                        (t = tr(o, {
                    ...
                    case rE:
                      e = tr(
                        n,
                        { opacity: [1, 0] },
                        { duration: s.exit, easing: "ease-out" }
                      );
                      break;
                    case rS:
                      null == t || t.cancel();
      ...
      tp(rR);
      let rL = (e) => {
          let { id: t, transitions: n, continuous: r } = e,
            a = (0, tu.useId)(),
            o = (0, tu.useRef)(n),
            s = tv(),
            i = tD();
          ...
          return (
            ...
            tu.createElement(tu.Fragment, null)
          );
        },
        rN = tp(rL);
    },
