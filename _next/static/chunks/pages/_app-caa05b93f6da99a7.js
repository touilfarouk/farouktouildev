(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [888],
  {
          ...
          return (0, a.jsx)(L.LH, {
            children: (0, a.jsxs)(L.fS, {
              ...
              children: [
                !!i &&
                  (0, a.jsx)("button", {
                    className: (0, L.cx)(N.pC, es, "czken64", ei),
                    onClick: () => {
                      var e;
                ...
                (0, a.jsx)(F(), {
                  href: t,
                  className: (0, L.cx)(
                    n ? (0, L.cx)(N.Eo, "czken6a") : (0, L.cx)(N.pC, ei),
                    "czken62"
                  ),
                  onClick: s,
                  children: r,
                ...
                !!l &&
                  (0, a.jsx)("button", {
                    className: (0, L.cx)(N.pC, es, "czken65", ei),
                    onClick: () => {
                      var e;
              ...
              children: (0, a.jsx)(L.LH, {
                children: (0, a.jsx)("div", {
                  ...
                  children: (0, a.jsxs)(L.fS, {
                    ...
                    target: "github",
                    className: (0, L.cx)(N.pC, ei, "czken67"),
            ...
            children: [
              (0, a.jsx)(C.T$, {
                ...
                left: (0, a.jsxs)(L.LH, {
                  ...
                  children: [
                    (0, a.jsx)(L.LH, {
                      children: (0, a.jsx)(C.TR, {
                        animated: (0, L.Wx)(),
                        children:
                          !u &&
                          (0, a.jsx)(L.LH, {
                            merge: !0,
                            children: (0, a.jsx)(C.nJ, {
                              className: N.bV,
                              animated: d,
                            }),
                          }),
              ...
              (0, a.jsx)(L.QS, {
                ...
                children: (0, a.jsx)(L.LH, {
                  root: !0,
                  active: l,
                  children: (0, a.jsx)(eg, { onClose: () => c(!1) }),
                }),
              }),
            ],
          });
        },
        eb = { duration: { enter: 0.15, exit: 0.15, stagger: 0.05 } },
        ev = {
          master: { volume: 0.8 },
          categories: {
            ...
            children: (0, a.jsxs)(L.ix, {
              ...
              children: [
                ...
                (0, a.jsxs)(L.LH, {
                  ...
                  children: [
                    (0, a.jsxs)(C.Zn, {
                      children: [(0, a.jsx)(eh, {}), (0, a.jsx)(t, { ...n })],
                    }),
                                  ...
                                  if (!(S instanceof a)) {
                                    ...
                                    if (h) {
                                      ...
                                      var j = E.index,
                                        ...
                                        R = k;
                                      for (R += w.value.length; j >= R; )
                                        R += (w = w.next).value.length;
                                      if (
                                        ((R -= w.value.length),
                                        (k = R),
                                      ...
                                      for (
                                        var L = w;
                                        L !== n.tail &&
                                        (R < O || "string" == typeof L.value);
                                        L = L.next
                                      )
                                        A++, (R += L.value.length);
                                      A--, (S = t.slice(k, R)), (E.index -= k);
                                    } else if (!(E = o(x, 0, S, y))) continue;
                                    var j = E.index,
                                      C = E[0],
                                      N = S.slice(0, j),
                                      _ = S.slice(j + C.length),
                                      $ = k + S.length;
                                    u && $ > u.reach && (u.reach = $);
                                    var F = w.prev;
    ...
    3473: function (e, t, n) {
      ...
      let v = a.default.forwardRef(function (e, t) {
          ...
          return L
            ...
            : a.default.createElement("a", { ...C, ...q }, n);
        }),
        x = v;
      ("function" == typeof t.default ||
        ("object" == typeof t.default && null !== t.default)) &&
    ...
    6663: function (e, t, n) {
          ...
          let n = t,
            a = {
              ...
              [C.exiting]: {
                onEntry: {
                  execute: () => {
                    Array.from(e.children).forEach((e) => {
                      e.state === C.entering || e.state === C.entered
                        ? e.send(N.exit)
                        : e.state === C.exited && e.scheduler.stopAll();
                    });
                  },
                  schedule: () => ({
                ...
                onActions: { [N.exitEnd]: C.exited, [N.enter]: C.entering },
              },
              "*": {
                onActions: {
                  [N.update]: () => {
                    ...
                    if (
                      ...
                      if ((n === C.exited || n === C.exiting) && e)
                        return C.entering;
                      if ((n === C.entered || n === C.entering) && !e)
                        return C.exiting;
                    }
                  },
                },
      ...
      let tp = (e, t) => (0, tu.memo)(e, t),
        ...
        th = (e) => {
          ...
          let [A, j] = (0, tu.useState)(
            () =>
              (a && (null == S ? void 0 : S.node.state) === C.exited) ||
              (o && (null == S ? void 0 : S.node.state) === C.entered) ||
              (s && E)
          );
          return (
            (0, tu.useEffect)(
            ...
            (0, tu.useEffect)(() => {
              if (S) {
                let e = S.node.subscribe((e) => {
                  j(
                    (a && e.state === C.exited) || (o && e.state === C.entered)
                  );
                });
                return () => e();
              }
      ...
      let tk = { x: "translateX", y: "translateY", z: "translateZ" },
        ...
        tj = (e) => {
          ...
          let {
            ...
            m = (0, tu.useRef)([]),
            [y, h] = (0, tu.useState)(
              () => (null == d ? void 0 : d.node.state) === C.exited
            ),
            [b, v] = (0, tu.useState)(
              () => (null == d ? void 0 : d.node.state) === C.entered
            ),
      ...
      (0, tu.memo)(
        (0, tu.forwardRef)((e, t) =>
          (0, tu.createElement)(tR, { elementRef: t, ...e })
        )
      );
      function tL(e, t, n, r) {
        var a;
      ...
      function tN(e, t = {}) {
        ...
        let r = (function (e, t = {}) {
          ...
          a = r.map((e) => e7(...e, eR)).filter(Boolean);
        return es(
          a,
          t,
      ...
      var nu = function (e, t, n) {
        ...
        nA =
          ...
          function (e) {
            return (
              void 0 === eL[e] &&
                (eL[e] = nE(e) ? e : e.replace(nw, "-$&").toLowerCase()),
              eL[e]
            );
          }),
        nj = function (e, t) {
      ...
      var nR = /label:\s*([^\s;\n{]+)\s*(;|$)/g,
        nL = function (e, t, n) {
          ...
          nR.lastIndex = 0;
          for (var l = ""; null !== (r = nR.exec(o)); ) l += "-" + r[1];
          return { name: nv(o) + l, styles: o, next: eN };
        },
        nC = !!td.useInsertionEffect && td.useInsertionEffect,
        nN =
          nC ||
          function (e) {
            return e();
          };
      nC || tu.useLayoutEffect;
      ...
      var nF = (0, tu.createContext)({}),
        ...
        nP =
          ((eC = function (e, t, n) {
            ...
            var u = nL(l, void 0, (0, tu.useContext)(nF));
            c += t.key + "-" + u.name;
            var d = {};
            for (var p in e)
          ...
          (0, tu.forwardRef)(function (e, t) {
            return eC(e, (0, tu.useContext)(n$), t);
          }));
      n(3463);
      var nD = function (e, t) {
        var n = arguments;
      ...
      let nB = "codacom-react-text-text",
        nz = (e) => {
          let {
            ...
            v = tv(),
            [x, w] = (0, tu.useState)(
              () => (null == v ? void 0 : v.node.state) === C.exited
            ),
            [k, E] = (0, tu.useState)(
              () => (null == v ? void 0 : v.node.state) === C.entered
            );
          return (
            (0, tu.useEffect)(() => {
              var e, t;
            ...
            (0, tu.useEffect)(() => {
              ...
              let e = "decipher" === s ? tl : ts,
                ...
                n = v.node.subscribe((e) => {
                  switch (
                    (E(e.state === C.entered), w(e.state === C.exited), e.state)
                  ) {
                    case "entered":
        ...
        nH = (e) => {
          ...
          let r = (0, tu.useCallback)(() => {
            ...
            let a = e.current,
              ...
              i = t.node.state === C.entering || t.node.state === C.entered;
      ...
      let rt = (e) => {
        ...
        rc = tp(rl),
        { entering: ru, entered: rd, exiting: rp, exited: rf } = C,
      ...
      tp(rw);
      let { entering: rk, exiting: rE, exited: rS } = C,
        ...
        rR = { lineWidth: 1, lineColor: "#777", distance: 30, sets: 5 },
        rL = (e) => {
          let t = { ...rR, ...e },
            { elementRef: n, className: r, style: a } = t,
            s = tv(),
